...
import application.ZuulAggApplication;
import application.entity.User;
import application.service.AggregationService;
import rx.Observable;
import rx.Observer;
@RestController
public class AggregationController {
	public static final Logger LOGGER = LoggerFactory.getLogger(ZuulAggApplication.class);
